...
public class HourlyTipsSolution {
    ...
    public JobExecutionResult execute() throws Exception {
        ...
        // event time watermarks are generated based on current timestamps, as these events are expected to arrive in
        // order
        DataStream<TaxiFare> fares =
                env.addSource(source)
                        .assignTimestampsAndWatermarks(
                                // event time watermarks are generated based on current timestamps, as taxi fares
                                // arrive in order
        ...
        // windows are generated by event timestamps
